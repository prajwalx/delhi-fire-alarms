...
export function DelhiFireAlarmsIcon0() {
  return (
    <SvgIcon sx={{ height: 21, width: 180, mr: 2 }}>
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        {/* The Tri-color Abstract Logo Icon */}
        <path
          fill="#B4C0D3"
          d="m.787 12.567 6.055-2.675 3.485 2.006.704 6.583-4.295-.035.634-4.577-.74-.422-3.625 2.817-2.218-3.697Z"
        />
  ...
  return (
    <SvgIcon sx={{ height: 21, width: 180, mr: 2 }}>
      ...
      >
        ...
        {/* Brand Text: DelhiFireAlarms */}
        <text
          x="32" // Moved slightly further right to make room for the new icon
          y="15"
          fill="#4876EE" // Preserved the original blue color for the text
          style={{ 
            fontFamily: 'Arial, sans-serif', 
            fontWeight: 'bold', 
            fontSize: '14px',
